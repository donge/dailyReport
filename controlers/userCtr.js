...
(function() {
  var Response, check, crypto, jwt, userModel, utils;
  ...
  exports.login = function(req, res) {
    ...
    return userModel.getAllUsersWithPassword(function(response) {
      var hasThisUser, id, key, property, ref, ref1, userId, users, value;
      if (response.state === 0) {
      ...
      for (key in users) {
        value = users[key];
        ref = key.split(":"), id = ref[0], property = ref[1];
      ...
      for (key in users) {
        value = users[key];
        ref1 = key.split(":"), id = ref1[0], property = ref1[1];
  ...
  exports.createUser = function(req, res) {
    var departmentId, error, error1, errorMessage, password, superiorId, userName;
  ...
  exports.updateUser = function(req, res) {
    var departmentId, error, error1, hashedPassword, password, superiorId, userId, userName;
    if (!utils.authenticateAdmin(req, res)) {
      return;
    }
    userId = req.body.userId;
